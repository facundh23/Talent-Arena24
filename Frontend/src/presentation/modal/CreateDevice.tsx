...
export const CreateDevice = ({
  ...
  return (
    <div className="w-full fixed inset-0 bg-indigo-600 bg-opacity-25 backdrop-blur-sm flex  justify-center items-start md:h-[100%]  lg:w-[100%] lg:mx-auto lg:h-[100%] z-40">
      <form
